            ...
            <tbody>
                ...
                <tr>
                    <td style="background: #fff; font-size: 25px; padding: 0 26px; text-align: center;">
                        ...
                        <p style="font-size: 18px;">We are happy to inform you that your appointment has been approved.</p>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="padding: 25px;">
                        <table width="100%" style="border-radius: 5px; border: 1px solid #000; padding: 13px 25px;">
                            <tr>
                                <td style="font-size: 20px; font-weight: 600;">When?: <?php echo $appointmentDetails['date']; ?></td>
                            </tr>
                            <tr>
                                <td style="font-size: 20px; font-weight: 600;">What time?: <?php echo $appointmentDetails['time_from']; ?> - <?php echo $appointmentDetails['time_to']; ?></td>
                            </tr>
