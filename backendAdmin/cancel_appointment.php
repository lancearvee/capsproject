...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        ob_start();
        include('../mail/reject_appointment.php');  
        ...
        $mail->send();
        session_start();
        $_SESSION['success'] = "Rejected and email sent!";
        echo "<script>sessionStorage.setItem('successMessage', 'Rejected and email sent!'); window.location.href = '../adminpage/pending.php';</script>";
        exit;
    } catch (Exception $e) {
