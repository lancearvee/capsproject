...
<section class="content">
  <div class="container-fluid">
    <div class="row">
      <div class="col-12">
        <div class="card">
        <div class="card-header header-container" style="padding-top: 20px;">
            <img src="../assets/medical_cert_logo.png" alt="Logo" class="logo">
            <div class="title-container">
              <h4 style="font-family: 'Poppins', sans-serif; color: maroon; margin-bottom: 10px; font-size: 40px;">
                  Uzziel R. de Mesa, MD, FPCP, DPSEDM
              </h4>

              <h4 class="custom-title" style ="font-size: 30px;">INTERNAL MEDICINE - ENDOCRINOLOGY</h4>
              <h4 class="ahmed-outline-title" style ="font-size: 30px;">
